...
const form = reactive({
  categoryId: '', titleUz: '', titleRu: '', descriptionUz: '', descriptionRu: '', type: 'Bouquet',
  price: 0, discountPrice: 0, stock: 0, images: [] as string[],
});

function openCreate() {
  editingId.value = null;
  Object.assign(form, { categoryId: '', titleUz: '', titleRu: '', descriptionUz: '', descriptionRu: '', type: 'Bouquet', price: 0, discountPrice: 0, stock: 0, images: [] });
  ...
  <div class="page">
    ...
    <AppModal :open="modalOpen" :title="editingId ? 'Mahsulotni tahrirlash' : 'Yangi mahsulot'" @close="modalOpen = false">
      <form class="form" @submit.prevent="save">
        ...
        <AppInput v-model="form.titleUz" label="Nomi (UZ)" />
        <AppInput v-model="form.titleRu" label="Nomi (RU)" />
        <AppTextarea v-model="form.descriptionUz" label="Tavsif (UZ)" />
        <AppTextarea v-model="form.descriptionRu" label="Tavsif (RU)" />
